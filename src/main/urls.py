...
from .views import main_view, home_view, list_view, listing_view, edit_view, like_listing_view, inquire_listing_using_email, delete_like_listing
...
urlpatterns = [
    ...
    path('delete-like/<uuid:id>/', delete_like_listing, name='delete_like_listing'),
]
